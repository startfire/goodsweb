...
<div class="g-doc">
    ...
    <table class="m-table m-table-row n-table g-b3">
        ...
        <tbody>
            ...
            <#assign total = total + (x.buyPrice?number)*x.buyNum>
            <tr>
                ...
                <td><span class="v-unit">¥(分)</span><span class="value">${x.buyPrice}</span></td>
            </tr>
            </#list>
        </tbody>
        <tfoot>
        <tr>
            ...
            <td><span class="v-unit">¥(分)</span><span class="value">${total?string(',###.##')}</span></td>
        </tr>
        </tfoot>
    </table>
    </#if>
